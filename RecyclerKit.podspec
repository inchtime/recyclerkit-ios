...
Pod::Spec.new do |s|
  s.name             = 'RecyclerKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RecyclerKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/evan-cai/RecyclerKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'evan-cai' => 'evan-cai@live.cn' }
  s.source           = { :git => 'https://github.com/evan-cai/RecyclerKit.git', :tag => s.version.to_s }
